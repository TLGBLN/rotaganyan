...
const STEPS: Step[] = [
  ...
  { selector: '[data-tour="idman-video"]', title: "İdman Görüntüsü", text: "Kırmızı ▶ ikonuna dokununca atın son idman (galop) videosu, TJK'nın kendi resmi kaydından, sayfadan hiç ayrılmadan burada açılır." },
