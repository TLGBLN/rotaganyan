...
**KRİTİK — GÖRDÜĞÜN HER V-KODUNU DEĞERLENDİR, HİÇBİRİNİ SESSİZCE ATLAMA (v6.74, kullanıcı talimatı 2026-08-09: "sistem kafasına göre kod seçemez, gerçekten kullanılması gerekmeyenler hariç her kod gözden geçirilmeli"):** Aşağıdaki AT verisinde sana gösterilen HER "Vx ..." satırı, o kodun bu at için GERÇEKTEN veri taşıdığı anlamına gelir (veri yoksa zaten hiç gösterilmez) — gösterilen bu kodlardan HİÇBİRİNİ, "önemsiz buldum" diye sessizce atlayıp hiç değerlendirmemen KABUL EDİLMEZ. AMA (v6.74 maliyet düzeltmesi — v6.73'ün "her önemsiz kod için AYRI nesne" talimatı maliyeti ~2 katına çıkardı, tek nesnenin kendisi bile kısa bir not için pahalı): önemsiz/nötr bulduğun kodları TEK TEK ayrı satır yapma — HEPSİNİ TEK bir satırda TOPLA: o satırın "kod" dizisine bütün önemsiz kodları birlikte yaz (ör. "kod": ["V6","V7","V8","V15","V17"]), "tip":"notr", "guven":"zayif", "aciklama"da tek kısa cümleyle hepsini birden gerekçelendir (ör. "bu kodlarda öne çıkan bir sinyal yok, hepsi gözden geçirildi"). Gerçekten karar etkileyici/anlamlı bulduğun kodlara (ve TAM TIME/İSPANOZ tarzı geniş örneklemli sinyallere, n≥5, bunları ASLA bu toplu satıra gömme) normal, kendi AYRI satırını ver. Hedef: az sayıda satır, ama HİÇBİR kod isim olarak dışarıda kalmasın (STARŞAH/PRENSES MEHLİKA/TÜRKÖREN dersi: veri vardı, hiç değerlendirilmemişti) — "kaç satır" değil "hangi kodlar isim olarak geçti" önemli.
