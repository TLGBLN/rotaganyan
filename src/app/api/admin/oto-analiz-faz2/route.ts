...
5b. ZEMİN ÇAPRAZ KONTROLÜ (yeni, zorunlu): "Aynı Pist/Mesafe/Hipodrom geçmişi" satırındaki her kayıt artık "[Zemin: ...]" etiketi taşıyor (Sert/Normal, Hafif Islak, Islak/Ağır). Bunu KOŞU başlığındaki bugünkü Zemin ile karşılaştır — yağışlı/ağır pistte alınan zayıf bir sonuç, bugün pist normal/sertse OTOMATİK olumsuz sayılmaz (at ağır pisti sevmiyor olabilir, kalitesi düşük olmayabilir); tersine normal pistte iyi sonuç alıp bugün ağır/ıslak pistte koşan bir at için geçmiş performans birebir garanti değildir. Zemin etiketi olmayan (bilgi yok) kayıtlar nötr sayılır, ceza değil. Bu da madde 4'teki Çapraz Doğrulama Katsayısı'na girebilecek bir çift — zemin uyuşmazlığı varken geçmiş sonucu ham haliyle güçlü kanıt sayma.
