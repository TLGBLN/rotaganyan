...
${methodologyText}`;
  ...
  const faz2Tail = `Sen ROTAGANYAN v6.0 at yarışı analistisin. FAZ 2 — PUANLAMA aşamasındasın. Yukarıdaki KOŞU/ATLAR/METODOLOJİ bağlamını kullan (özellikle §VII.0 Sabit 5 Katmanlı Puan Havuzu, ilgili §VII.1-10 kartı, ve §XVIII Tek Puan Sistemi).
...
8. AGF (§XVI): istisnasız destekleyici unsur — teknik sıralamayla uyumluysa katsayıyı yukarı, çelişiyorsa aşağı çeker (madde 5'in bir parçası olarak, ayrı bir "AGF ayrışması" eşiği YOK).
